...
const LeaveApplication = () => {
  return (
    <div className="bg-light p-3" style={{ minHeight: '100vh' }}>
      <div className="container bg-white p-4 shadow-sm" style={{ maxWidth: '100%', overflowX: 'auto' }}>
        ...
        <div className="border-top border-bottom border-secondary py-2">
          <div className="row">
            ...
            <div className="col-md-6">
              <p className="small font-weight-bold">
                2. NAME: (Last) <span className="underline">ANDUJAR</span> (First){' '}
                <span className="underline">RENE</span> (Middle) <span className="underline">B</span>
              </p>
            </div>
          </div>
          <div className="row mt-2">
            <div className="col-md-3">
              ...
              <p className="small">April 12, 2024</p>
            </div>
            <div className="col-md-3">
              <p className="small font-weight-bold">4. POSITION</p>
              <p className="small">ITO-I</p>
            </div>
            <div className="col-md-3">
        ...
        <div className="border-bottom border-secondary py-2">
          ...
          <div className="mt-2">
            ...
            <p className="small">April 8, 2024</p>
          </div>
          <div className="mt-2">
